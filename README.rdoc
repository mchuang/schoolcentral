...
=== TESTING
test_admin => {Username: “test_admin”, Password: “password”}<br>
test_teacher => {Username: “test_teacher”, Password: “password”}<br> 
test_student => {Username: “test_student”, Password: “password”}<br>
